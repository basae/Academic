...
namespace ApiAcademic.Core
{
    ...
    public class TokenAuthenticationFilter:IAuthorizationFilter
    {
        ...
        public async Task<HttpResponseMessage> ExecuteAuthorizationFilterAsync(HttpActionContext actionContext, CancellationToken cancellationToken, Func<Task<HttpResponseMessage>> continuation)
        {
            ...
            var usr = AuthenticateRequest(actionContext.Request);
            if (usr != null)
            {
        ...
        private static User AuthenticateRequest(HttpRequestMessage request)
        {
            ...
            try
            {
                ...
                usr = new User(currentUser.userId, currentUser.realName, "User", true);
            }
            catch
            {
                usr = null;
